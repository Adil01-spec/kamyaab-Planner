        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <Link to="/home" className="inline-block mb-3">
              <h3 className="text-lg font-semibold text-foreground/80">Kaamyab</h3>
            </Link>
          ...
          {/* Product Links */}
          <div>
            <h4 className="text-sm font-medium text-foreground/70 mb-4">Product</h4>
          ...
          {/* Company Links */}
          <div>
            <h4 className="text-sm font-medium text-foreground/70 mb-4">Company</h4>
            <ul className="space-y-3">
